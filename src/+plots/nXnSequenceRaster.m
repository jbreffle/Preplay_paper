function figHandle = nXnSequenceRaster(network_spike_sequences, plotIDs, spikes_V_m, parameters, network, varargin)
...
% plots.nXnSequenceRaster(network_spike_sequences, plotIDs, spikes_V_m, parameters); % generate figure, with E-cells sorted and I-cells unsorted
...
for i=1:2:length(varargin)
    switch varargin{i}
        ...
        otherwise
            error('plots.nXnSequenceRaster: Unknown input')
    end
end
