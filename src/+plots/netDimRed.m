function [figHandleSubplots, figHandleSingle] = netDimRed(network, dimRedInput, varargin)
...
% plots.netDimRed(network, dimRedInput, 'seed', seed, 'E_only', E_only, 'scatterSize', scatterSize);
...
for i=1:2:length(varargin)
    switch varargin{i}
        ...
        otherwise
            error('plots.netDimRed: Unknown input')
    end
end
...
switch dimRedInput
    ...
    case 'clust'
        ...
        X = op';
    otherwise
        error('plots.netDimRed: Unknown dimRedInput option')
end
